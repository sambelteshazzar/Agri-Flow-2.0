...
const NewsHub: React.FC = () => {
  ...
  const getCategoryColor = (cat: string) => {
    switch (cat) {
      ...
      case 'Market': return 'bg-crimson-100 text-crimson-700 border-crimson-200 dark:bg-crimson-900/30 dark:text-crimson-300 dark:border-crimson-800';
      ...
      default: return 'bg-terra-100 text-terra-700 border-terra-200 dark:bg-crimson-800 dark:text-crimson-300 dark:border-crimson-700';
    }
  };
    ...
    <div className="space-y-6 animate-fade-in pb-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end organic-divider pb-4 transition-colors">
        ...
        <button 
          ...
          className="mt-4 md:mt-0 flex items-center px-4 py-2 bg-crimson-800 dark:bg-sunburst-100 border border-crimson-800 dark:border-sunburst-200 text-white dark:text-crimson-900 rounded hover:opacity-90 transition-opacity text-xs font-semibold shadow-sm disabled:opacity-50 active:scale-95"
        >
      ...
      {isLoadingNews && newsArticles.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-96 text-crimson-400 bg-terra-50 dark:bg-crimson-900/50 rounded-2xl border border-primary-dynamic">
           <div className="relative">
             <div className="absolute inset-0 bg-crimson-500/20 rounded-full animate-ping"></div>
             <Loader2 className="w-12 h-12 mb-4 animate-spin text-crimson-600 dark:text-crimson-400 relative z-10" />
           </div>
           <p className="text-sm font-semibold text-secondary-dynamic">Pulling latest stories...</p>
           <p className="text-[10px] text-crimson-500 mt-2">Aggregating global agricultural news</p>
        </div>
      ) : newsArticles.length > 0 ? (
        <>
          {featuredArticle && (
            <div className="relative h-[450px] rounded-2xl overflow-hidden shadow-2xl group cursor-pointer border border-crimson-900/20 dark:border-crimson-700/30">
               <img 
               ...
               />
               <div className="absolute inset-0 bg-gradient-to-t from-crimson-950 via-crimson-950/80 to-transparent opacity-90 group-hover:opacity-100 transition-opacity"></div>
               ...
               <div className="absolute bottom-0 left-0 p-6 md:p-10 w-full max-w-4xl">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-[10px] font-semibold text-crimson-300 bg-black/40 px-2 py-1 rounded backdrop-blur-sm">Featured</span>
                  </div>
                  ...
                  <p className="text-crimson-200 text-sm md:text-lg font-medium leading-relaxed mb-8 line-clamp-2 max-w-3xl drop-shadow-md">
                    {featuredArticle.summary}
                  </p>
                  
                  <div className="flex items-center gap-4 text-xs font-semibold text-crimson-400 border-t border-white/10 pt-4">
                     ...
                     <a 
                       ...
                       target="_blank" 
                       rel="noreferrer" 
                       className="ml-auto flex items-center gap-2 px-4 py-2 bg-sunburst-500 text-crimson-900 rounded-lg hover:bg-sunburst-400 transition-all shadow-lg active:scale-95"
                     >
               ...
               <div key={article.id} className="card-surface rounded-xl overflow-hidden flex flex-col group hover:-translate-y-1">
                  <div className="h-44 overflow-hidden relative">
                     ...
                     <div className="absolute top-3 right-3">
                        <span className={`inline-flex items-center gap-1 px-2 py-1 rounded text-[10px] font-semibold border shadow-sm ${getCategoryColor(article.category)} bg-white/95 dark:bg-crimson-900/90 backdrop-blur-sm`}>
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                     <div className="mb-4">
                        <h4 className="font-bold text-primary-dynamic text-lg leading-tight mb-2 group-hover:text-crimson-600 dark:group-hover:text-crimson-400 transition-colors line-clamp-2">
                          {article.title}
                        </h4>
                     ...
                     <div className="mt-auto pt-4 organic-divider flex justify-between items-center text-[10px] font-semibold text-crimson-500 dark:text-crimson-400">
                     ...
                     <a 
                       ...
                       target="_blank" 
                       rel="noreferrer" 
                       className="mt-3 block w-full text-center py-2.5 bg-terra-50 dark:bg-crimson-800 hover:bg-terra-100 dark:hover:bg-crimson-700 text-secondary-dynamic text-xs font-semibold rounded-lg border border-primary-dynamic transition-colors"
                     >
                        Read Source
                     </a>
                  </div>
        ...
        <div className="p-12 text-center border-2 border-dashed border-primary-dynamic rounded-2xl bg-terra-50 dark:bg-crimson-900/30">
           <div className="w-16 h-16 bg-terra-200 dark:bg-crimson-800 rounded-full flex items-center justify-center mx-auto mb-4">
             <Newspaper className="w-8 h-8 text-crimson-400" />
           </div>
           ...
           <button 
             onClick={refreshNews} 
             className="px-6 py-3 bg-crimson-600 hover:bg-crimson-500 text-white rounded-lg font-semibold text-xs shadow-md transition-all active:scale-95"
           >
             Retry Connection
           </button>
        </div>
