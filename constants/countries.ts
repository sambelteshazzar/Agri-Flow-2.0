...
export const COUNTRY_REGISTRY: Record<string, CountryConfig> = {
  ...
  GH: {
    ...
    learningModules: [
      { id: '1', title: 'Cocoa Rehabilitation & CSSD Management', instructor: 'Dr. Francis Owusu (CRIG)', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Resilience', difficulty: 'Advanced', duration: '3h 45m', completed: false, description: 'Identifying CSSD symptoms, removing infected trees, and replanting with tolerant hybrids. Best practices for rehabilitating aged cocoa farms.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Oil Palm Best Practices for smallholders', instructor: 'Kofi Mensah (OPRI)', thumbnail: '/stock/education.svg', lessonsCount: 8, category: 'Economics', difficulty: 'Intermediate', duration: '2h 30m', completed: false, description: 'Maximizing oil palm yields on smallholder plots. Harvest timing, pruning, and integrated pest management.', videoId: '', progress: 0, completedLessons: [] },
      { id: '3', title: 'Climate-Smart Maize for Transitional Zones', instructor: 'CSIR-SARI Team', thumbnail: '/stock/education.svg', lessonsCount: 6, category: 'Resilience', difficulty: 'Beginner', duration: '1h 30m', completed: false, description: 'Drought-tolerant varieties, Striga management, and conservation agriculture for Ghana transitional zones.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  KE: {
    ...
    learningModules: [
      { id: '1', title: 'Climate-Smart Farming for ASAL Counties', instructor: 'KALRO Research Team', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Resilience', difficulty: 'Intermediate', duration: '3h 00m', completed: false, description: 'Drought-tolerant varieties, water harvesting, and conservation agriculture for Kenya arid and semi-arid lands.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Export-Grade French Bean Production', instructor: 'HCDA Inspector Team', thumbnail: '/stock/education.svg', lessonsCount: 8, category: 'Economics', difficulty: 'Advanced', duration: '2h 30m', completed: false, description: 'Meeting EU MRL requirements, GlobalGAP certification, and post-harvest handling for premium export beans.', videoId: '', progress: 0, completedLessons: [] },
      { id: '3', title: 'Coffee Quality Improvement', instructor: 'Coffee Research Institute', thumbnail: '/stock/education.svg', lessonsCount: 12, category: 'Economics', difficulty: 'Advanced', duration: '4h 00m', completed: false, description: 'Cherry selection, wet processing, and drying techniques to achieve specialty grade. Market linkage for premium lots.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  IN: {
    ...
    learningModules: [
      { id: '1', title: 'Direct Seeded Rice for Water Savings', instructor: 'ICAR-IIRR Team', thumbnail: '/stock/education.svg', lessonsCount: 8, category: 'Tech', difficulty: 'Intermediate', duration: '2h 00m', completed: false, description: 'DSR technique reduces water use by 30% and labor costs. Suitable for Punjab, Haryana and UP rice-wheat zones.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Cotton IPM for Pink Bollworm', instructor: 'ICAR-CICR Nagpur', thumbnail: '/stock/education.svg', lessonsCount: 6, category: 'Resilience', difficulty: 'Advanced', duration: '1h 45m', completed: false, description: 'Refugia management, pheromone traps, and biological control for PBW in Bt cotton. Reducing pesticide reliance.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  BR: {
    ...
    learningModules: [
      { id: '1', title: 'Soybean Rust Resistance Management', instructor: 'Embrapa Soja Team', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Resilience', difficulty: 'Advanced', duration: '3h 30m', completed: false, description: 'Fungicide rotation, resistance monitoring, and integrated management for Asian Soybean Rust in Cerrado regions.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Precision Agriculture for Sugarcane', instructor: 'RIDEISA/UFV', thumbnail: '/stock/education.svg', lessonsCount: 12, category: 'Tech', difficulty: 'Advanced', duration: '4h 00m', completed: false, description: 'Variable rate application, yield mapping, and soil sampling for sugarcane precision management. Reducing input costs 20%.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  US: {
    ...
    learningModules: [
      { id: '1', title: 'Precision Ag for Corn-Soy Rotation', instructor: 'Extension Service (Iowa State)', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Tech', difficulty: 'Intermediate', duration: '3h 00m', completed: false, description: 'VRT fertilizer, drone scouting, and yield monitor analysis for Midwest corn-soybean systems.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Cover Crop Economics', instructor: 'SARE/USDA-NRCS', thumbnail: '/stock/education.svg', lessonsCount: 6, category: 'Resilience', difficulty: 'Beginner', duration: '1h 30m', completed: false, description: 'Cost-share programs, soil health benefits, and grazing value of cover crops in row crop systems.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  ET: {
    ...
    learningModules: [
      { id: '1', title: 'Coffee Quality & Processing for Premium Markets', instructor: 'JARC Research Team', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Economics', difficulty: 'Advanced', duration: '3h 30m', completed: false, description: 'Wet and dry processing methods, quality grading, and specialty coffee market access for Ethiopian growers.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Teff Agronomy for Smallholders', instructor: 'EIAR/Ambo Center', thumbnail: '/stock/education.svg', lessonsCount: 6, category: 'Resilience', difficulty: 'Beginner', duration: '1h 30m', completed: false, description: 'Quncho variety management, sowing rates, and nitrogen top-dressing timing. Increasing teff yields on smallholder plots.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  SN: {
    ...
    learningModules: [
      { id: '1', title: 'Groundnut Aflatoxin Prevention', instructor: 'ISRA/CORAF Team', thumbnail: '/stock/education.svg', lessonsCount: 8, category: 'Resilience', difficulty: 'Intermediate', duration: '2h 00m', completed: false, description: 'Harvest timing, proper drying, and storage techniques to minimize aflatoxin contamination in groundnut.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Sahel Irrigation Techniques', instructor: 'AfricaRice Sahel Station', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Tech', difficulty: 'Intermediate', duration: '3h 00m', completed: false, description: 'Smallholder irrigation options for the Sahel: treadle pumps, California drip systems, and lowland rice management.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  AU: {
    ...
    learningModules: [
      { id: '1', title: 'No-Till Farming for Dryland Cropping', instructor: 'GRDC Research Team', thumbnail: '/stock/education.svg', lessonsCount: 8, category: 'Resilience', difficulty: 'Intermediate', duration: '2h 30m', completed: false, description: 'No-till establishment, stubble retention, and controlled traffic farming for Australian dryland systems. Soil health and moisture conservation.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Grazing Management for Rangelands', instructor: 'MLA/DPIRD Team', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Resilience', difficulty: 'Advanced', duration: '3h 00m', completed: false, description: 'Cell grazing, stocking rate calculations, and drought management for extensive sheep and cattle operations.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  DE: {
    ...
    learningModules: [
      { id: '1', title: 'CAP 2026 Compliance & Eco-Schemes', instructor: 'Bundesinformation Landwirtschaft', thumbnail: '/stock/education.svg', lessonsCount: 8, category: 'Economics', difficulty: 'Intermediate', duration: '2h 30m', completed: false, description: 'Updated CAP eco-scheme requirements, EFA compliance, and green payment eligibility for 2026.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Precision Dairy Management', instructor: 'DLG Expert Panel', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Tech', difficulty: 'Advanced', duration: '3h 00m', completed: false, description: 'Automated milking, health monitoring collars, and feed optimization for European dairy operations.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  TH: {
    ...
    learningModules: [
      { id: '1', title: 'SRI Rice for Water Conservation', instructor: 'Rice Department Thailand', thumbnail: '/stock/education.svg', lessonsCount: 8, category: 'Resilience', difficulty: 'Intermediate', duration: '2h 00m', completed: false, description: 'System of Rice Intensification for Thai jasmine rice. Reducing water use 40% while maintaining quality grade.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Rubber Latex Quality & Tapping Efficiency', instructor: 'RRIT Research Division', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Economics', difficulty: 'Advanced', duration: '3h 00m', completed: false, description: 'Optimizing tapping panels, rain guarding, and latex preservation for THB/kg margin improvement.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
  ...
  MX: {
    ...
    learningModules: [
      { id: '1', title: 'Avocado Export Quality & Phytosanitary', instructor: 'INIFAP/CESAVEG Team', thumbnail: '/stock/education.svg', lessonsCount: 10, category: 'Economics', difficulty: 'Advanced', duration: '3h 00m', completed: false, description: 'Post-harvest handling, packing standards, and phytosanitary certification for avocado export to US and Asian markets.', videoId: '', progress: 0, completedLessons: [] },
      { id: '2', title: 'Coffee Leaf Rust Management', instructor: 'INIFAP Coffee Program', thumbnail: '/stock/education.svg', lessonsCount: 8, category: 'Resilience', difficulty: 'Intermediate', duration: '2h 30m', completed: false, description: 'Identifying CLR symptoms, fungicide timing, and transitioning to resistant Lempira and Oro Azteca varieties.', videoId: '', progress: 0, completedLessons: [] },
    ],
    tasks: [
