...
export const COUNTRY_REGISTRY: Record<string, CountryConfig> = {
  ...
  GH: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Cocoa', variety: 'Amelonado (Hybrid)', plantingDate: '2026-04-01', harvestDate: '2026-11-30', status: 'Healthy', area: 40, imageUrl: '/stock/cocoa.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 72 },
      { id: '2', name: 'Oil Palm', variety: 'Tenera (OPRI)', plantingDate: '2026-03-15', harvestDate: '2027-02-28', status: 'Healthy', area: 25, imageUrl: '/stock/oil-palm.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 55 },
      { id: '3', name: 'Maize', variety: 'Obatanpa (CSIR)', plantingDate: '2026-05-01', harvestDate: '2026-09-15', status: 'Needs Attention', area: 15, imageUrl: '/stock/maize.svg', soilHealth: 'Degraded', waterEfficiency: 'Low', biodiversityScore: 30 },
      { id: '4', name: 'Rice', variety: 'CRI-Amankraw (Inland Valley)', plantingDate: '2026-06-15', harvestDate: '2026-10-30', status: 'Healthy', area: 10, imageUrl: '/stock/rice.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 60 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Dagbon Cattle Herd', species: 'Cattle', count: 40, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/crop-default.svg', notes: 'Sanga cattle. Free-range grazing with dry season supplementation.' },
      { id: '2', name: 'Free-Range Poultry', species: 'Chicken', count: 180, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/cattle.svg', notes: 'Newcastle + Gumboro vaccination completed Q1 2026.' },
      { id: '3', name: 'West African Dwarf Goats', species: 'Goat', count: 35, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/chicken.svg', notes: 'Dwarf goat breed. Dual-purpose (meat and manure).' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'Cocoa Rehabilitation & CSSD Management', instructor: 'Dr. Francis Owusu (CRIG)', thumbnail: '/stock/cocoa.svg', lessonsCount: 10, category: 'Resilience', difficulty: 'Advanced', duration: '3h 45m', completed: false, description: 'Identifying CSSD symptoms, removing infected trees, and replanting with tolerant hybrids. Best practices for rehabilitating aged cocoa farms.', videoId: '3VfJxKq3wJ0', progress: 0, completedLessons: [] },
      { id: '2', title: 'Oil Palm Best Practices for smallholders', instructor: 'Kofi Mensah (OPRI)', thumbnail: '/stock/oil-palm.svg', lessonsCount: 8, category: 'Economics', difficulty: 'Intermediate', duration: '2h 30m', completed: false, description: 'Maximizing oil palm yields on smallholder plots. Harvest timing, pruning, and integrated pest management.', videoId: 'p4mEjL6y6Vk', progress: 0, completedLessons: [] },
      { id: '3', title: 'Climate-Smart Maize for Transitional Zones', instructor: 'CSIR-SARI Team', thumbnail: '/stock/maize.svg', lessonsCount: 6, category: 'Resilience', difficulty: 'Beginner', duration: '1h 30m', completed: false, description: 'Drought-tolerant varieties, Striga management, and conservation agriculture for Ghana transitional zones.', videoId: 'h2P5z2Q3yJ0', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    marketplaceListings: [
      { id: '1', type: 'SELL', item: 'Premium Cocoa Beans - 5 Tons (Grade 1)', price: 'GH₵14,500/100kg', location: 'Kumasi, Ghana', contact: 'kwame@cocoaashanti.co', verified: true, status: 'ACTIVE', date: new Date(Date.now() - 86400000).toISOString(), image: '/stock/crop-default.svg' },
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Kofi M.', text: 'Rain has been steady in Ashanti region. Cocoa flowering looks good this year — fingers crossed for a strong main crop.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
      { id: '2', channelId: 'market', author: 'Akua T.', text: 'Cocoa at GH₵14,500 per bag in Kumasi. International prices still strong. Good time to sell if you have quality beans.', timestamp: new Date(Date.now() - 1800000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Kwame Asante', role: 'Cocoa Specialist (Ghana)', img: '/stock/user.svg', mutual: 22 },
      { id: 'sf2', name: 'Dr. Francis Owusu', role: 'CRIG Agronomist', img: '/stock/crop-default.svg', mutual: 15 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'CocoaCo GH', img: '/stock/user.svg', hasUpdate: true },
      { id: '2', name: 'OilPalm Assoc', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  KE: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Maize', variety: 'Hybrid H614 (KALRO)', plantingDate: '2026-03-01', harvestDate: '2026-08-15', status: 'Needs Attention', area: 20, imageUrl: '/stock/maize.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 45 },
      { id: '2', name: 'Tea', variety: 'Purple Tea (TRFK 306/1)', plantingDate: '2024-06-01', harvestDate: '2026-12-31', status: 'Healthy', area: 15, imageUrl: '/stock/crop-default.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 65 },
      { id: '3', name: 'French Beans', variety: 'Serengeti (Export)', plantingDate: '2026-05-01', harvestDate: '2026-07-15', status: 'Healthy', area: 5, imageUrl: '/stock/cowpea.svg', soilHealth: 'Excellent', waterEfficiency: 'High', biodiversityScore: 78 },
      { id: '4', name: 'Coffee', variety: 'SL28 (Arabica)', plantingDate: '2023-04-01', harvestDate: '2026-12-31', status: 'Healthy', area: 10, imageUrl: '/stock/cocoa.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 58 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Zebu Cattle Herd', species: 'Cattle', count: 30, status: 'Healthy', grazingType: 'Rotational', imageUrl: '/stock/crop-default.svg', notes: 'Boran crossbreeds. Zero-grazing with cut-and-carry system.' },
      { id: '2', name: 'Improved Layer Flock', species: 'Chicken', count: 500, status: 'Healthy', grazingType: 'Feedlot', imageUrl: '/stock/cattle.svg', notes: 'Kenchic layers. Biosecurity protocols in place. Newcastle vaccination Q1 2026.' },
      { id: '3', name: 'Galla Goat Herd', species: 'Goat', count: 45, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/chicken.svg', notes: 'Galla goat breed for ASAL regions. Drought-hardy dual-purpose.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'Climate-Smart Farming for ASAL Counties', instructor: 'KALRO Research Team', thumbnail: '/stock/crop-default.svg', lessonsCount: 10, category: 'Resilience', difficulty: 'Intermediate', duration: '3h 00m', completed: false, description: 'Drought-tolerant varieties, water harvesting, and conservation agriculture for Kenya arid and semi-arid lands.', videoId: '3VfJxKq3wJ0', progress: 0, completedLessons: [] },
      { id: '2', title: 'Export-Grade French Bean Production', instructor: 'HCDA Inspector Team', thumbnail: '/stock/vegetable.svg', lessonsCount: 8, category: 'Economics', difficulty: 'Advanced', duration: '2h 30m', completed: false, description: 'Meeting EU MRL requirements, GlobalGAP certification, and post-harvest handling for premium export beans.', videoId: 'p4mEjL6y6Vk', progress: 0, completedLessons: [] },
      { id: '3', title: 'Coffee Quality Improvement', instructor: 'Coffee Research Institute', thumbnail: '/stock/cocoa.svg', lessonsCount: 12, category: 'Economics', difficulty: 'Advanced', duration: '4h 00m', completed: false, description: 'Cherry selection, wet processing, and drying techniques to achieve specialty grade. Market linkage for premium lots.', videoId: '6S6PJ8W1gbM', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    marketplaceListings: [
      { id: '1', type: 'SELL', item: 'AA Specialty Green Coffee - 2 Tons', price: 'KSh 850/kg', location: 'Nyeri, Kenya', contact: 'farm@kenyacoffee.co', verified: true, status: 'ACTIVE', date: new Date(Date.now() - 86400000).toISOString(), image: '/stock/crop-default.svg' },
    ],
    forumPosts: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'James K.', text: 'Long rains have started in Nakuru but lighter than usual. KMD says below average for 2026 — consider drought-tolerant maize varieties.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Wanjiku Njeri', role: 'Tea Grower (Kiambu)', img: '/stock/crop-default.svg', mutual: 12 },
      { id: 'sf2', name: 'Dr. Kipchoge', role: 'KALRO Agronomist', img: '/stock/user.svg', mutual: 8 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'KenyaTea', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  IN: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Rice (Kharif)', variety: 'Pusa Basmati 1121', plantingDate: '2026-06-15', harvestDate: '2026-11-15', status: 'Healthy', area: 25, imageUrl: '/stock/rice.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 50 },
      { id: '2', name: 'Wheat (Rabi)', variety: 'HD-3226 (ICAR)', plantingDate: '2025-11-15', harvestDate: '2026-04-15', status: 'Harvest Ready', area: 20, imageUrl: '/stock/sorghum.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 55 },
      { id: '3', name: 'Cotton', variety: 'Bt Cotton (Bollgard III)', plantingDate: '2026-05-01', harvestDate: '2026-12-31', status: 'Needs Attention', area: 15, imageUrl: '/stock/crop-default.svg', soilHealth: 'Degraded', waterEfficiency: 'Low', biodiversityScore: 28 },
      { id: '4', name: 'Sugarcane', variety: 'Co 0238 (ICAR)', plantingDate: '2026-03-01', harvestDate: '2027-02-28', status: 'Healthy', area: 10, imageUrl: '/stock/sorghum.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 42 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Murrah Buffalo Herd', species: 'Cattle', count: 12, status: 'Lactating', grazingType: 'Feedlot', imageUrl: '/stock/crop-default.svg', notes: 'Murrah buffalo for dairy. Stall-fed with green fodder and concentrate.' },
      { id: '2', name: 'Backyard Poultry', species: 'Chicken', count: 200, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/cattle.svg', notes: 'Dual-purpose birds (Kadaknath cross). Vaccinated for Ranikhet disease.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'Direct Seeded Rice for Water Savings', instructor: 'ICAR-IIRR Team', thumbnail: '/stock/rice.svg', lessonsCount: 8, category: 'Tech', difficulty: 'Intermediate', duration: '2h 00m', completed: false, description: 'DSR technique reduces water use by 30% and labor costs. Suitable for Punjab, Haryana and UP rice-wheat zones.', videoId: '1s5o7s3y_wY', progress: 0, completedLessons: [] },
      { id: '2', title: 'Cotton IPM for Pink Bollworm', instructor: 'ICAR-CICR Nagpur', thumbnail: '/stock/crop-default.svg', lessonsCount: 6, category: 'Resilience', difficulty: 'Advanced', duration: '1h 45m', completed: false, description: 'Refugia management, pheromone traps, and biological control for PBW in Bt cotton. Reducing pesticide reliance.', videoId: '6S6PJ8W1gbM', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Priya M.', text: 'IMD monsoon forecast is normal for 2026. Good news for Kharif planting. Start nursery preparations now.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Rajinder Singh', role: 'Rice Farmer (Punjab)', img: '/stock/user.svg', mutual: 14 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'PunjabRice', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  BR: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Soybeans', variety: 'BMX Potencia RR', plantingDate: '2025-10-15', harvestDate: '2026-03-30', status: 'Harvest Ready', area: 100, imageUrl: '/stock/cowpea.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 38 },
      { id: '2', name: 'Sugarcane', variety: 'RB867515 (RIDESA)', plantingDate: '2025-04-01', harvestDate: '2026-12-31', status: 'Healthy', area: 60, imageUrl: '/stock/sorghum.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 32 },
      { id: '3', name: 'Coffee (Arabica)', variety: 'Catuaí Vermelho IAC 99', plantingDate: '2023-11-01', harvestDate: '2026-10-31', status: 'Healthy', area: 30, imageUrl: '/stock/cocoa.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 55 },
      { id: '4', name: 'Corn (Safrinha)', variety: 'DKB 230 PRO3', plantingDate: '2026-02-01', harvestDate: '2026-07-31', status: 'Needs Attention', area: 50, imageUrl: '/stock/maize.svg', soilHealth: 'Degraded', waterEfficiency: 'Low', biodiversityScore: 25 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Nelore Beef Herd', species: 'Cattle', count: 200, status: 'Healthy', grazingType: 'Rotational', imageUrl: '/stock/crop-default.svg', notes: 'Nelore cattle on Brachiaria pasture. Rotational grazing with supplemental mineral salt.' },
      { id: '2', name: 'Broiler Integration', species: 'Chicken', count: 15000, status: 'Healthy', grazingType: 'Feedlot', imageUrl: '/stock/cattle.svg', notes: 'Contract broiler production. Full biosecurity and automated feed/water systems.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'Soybean Rust Resistance Management', instructor: 'Embrapa Soja Team', thumbnail: '/stock/crop-default.svg', lessonsCount: 10, category: 'Resilience', difficulty: 'Advanced', duration: '3h 30m', completed: false, description: 'Fungicide rotation, resistance monitoring, and integrated management for Asian Soybean Rust in Cerrado regions.', videoId: '6S6PJ8W1gbM', progress: 0, completedLessons: [] },
      { id: '2', title: 'Precision Agriculture for Sugarcane', instructor: 'RIDEISA/UFV', thumbnail: '/stock/crop-default.svg', lessonsCount: 12, category: 'Tech', difficulty: 'Advanced', duration: '4h 00m', completed: false, description: 'Variable rate application, yield mapping, and soil sampling for sugarcane precision management. Reducing input costs 20%.', videoId: 'G9K7z9JcQj8', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Pedro S.', text: 'Rust pressure increasing in MT. If you have not sprayed preventive, do it now. Early action saves yield.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Carlos Mendes', role: 'Soybean Farmer (MT)', img: '/stock/user.svg', mutual: 8 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'Embrapa', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  US: {
    ...
    areaUnit: 'acres',
    defaultCrops: [
      { id: '1', name: 'Corn', variety: 'Pioneer P1197', plantingDate: '2026-04-20', harvestDate: '2026-10-15', status: 'Healthy', area: 500, imageUrl: '/stock/maize.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 35 },
      { id: '2', name: 'Soybeans', variety: 'Asgrow AG38X6', plantingDate: '2026-05-01', harvestDate: '2026-10-30', status: 'Healthy', area: 400, imageUrl: '/stock/cowpea.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 40 },
      { id: '3', name: 'Winter Wheat', variety: 'Syngress SY Monument', plantingDate: '2025-10-01', harvestDate: '2026-07-15', status: 'Harvest Ready', area: 200, imageUrl: '/stock/sorghum.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 48 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Beef Cattle Herd', species: 'Cattle', count: 150, status: 'Healthy', grazingType: 'Rotational', imageUrl: '/stock/crop-default.svg', notes: 'Angus cross. Rotational grazing on improved pasture. AI breeding program.' },
      { id: '2', name: 'Layer Operation', species: 'Chicken', count: 5000, status: 'Healthy', grazingType: 'Feedlot', imageUrl: '/stock/cattle.svg', notes: 'Cage-free layer barn. Avian influenza biosecurity in effect.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'Precision Ag for Corn-Soy Rotation', instructor: 'Extension Service (Iowa State)', thumbnail: '/stock/maize.svg', lessonsCount: 10, category: 'Tech', difficulty: 'Intermediate', duration: '3h 00m', completed: false, description: 'VRT fertilizer, drone scouting, and yield monitor analysis for Midwest corn-soybean systems.', videoId: 'G9K7z9JcQj8', progress: 0, completedLessons: [] },
      { id: '2', title: 'Cover Crop Economics', instructor: 'SARE/USDA-NRCS', thumbnail: '/stock/vegetable.svg', lessonsCount: 6, category: 'Resilience', difficulty: 'Beginner', duration: '1h 30m', completed: false, description: 'Cost-share programs, soil health benefits, and grazing value of cover crops in row crop systems.', videoId: '3VfJxKq3wJ0', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Sarah B.', text: 'Wheat looking good in NE Iowa. Harvest should be early this year. Custom combiner booked for July 10.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Mike Johnson', role: 'Row Crop Farmer (Iowa)', img: '/stock/user.svg', mutual: 5 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'IowaFarmBureau', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  ET: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Coffee (Arabica)', variety: 'Jimma Local (Wollega)', plantingDate: '2024-06-01', harvestDate: '2026-12-31', status: 'Healthy', area: 8, imageUrl: '/stock/cocoa.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 75 },
      { id: '2', name: 'Teff', variety: 'Quncho (DZ-Cr-387)', plantingDate: '2026-07-01', harvestDate: '2026-11-15', status: 'Healthy', area: 5, imageUrl: '/stock/crop-default.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 55 },
      { id: '3', name: 'Maize', variety: 'BH661 (Ambo)', plantingDate: '2026-05-15', harvestDate: '2026-10-30', status: 'Needs Attention', area: 4, imageUrl: '/stock/maize.svg', soilHealth: 'Degraded', waterEfficiency: 'Low', biodiversityScore: 30 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Local Zebu Herd', species: 'Cattle', count: 25, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/crop-default.svg', notes: 'Abyssinian zebu. Free grazing with crop residue supplementation.' },
      { id: '2', name: 'Sheep Flock', species: 'Sheep', count: 40, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/cattle.svg', notes: 'Menz sheep breed. Dual-purpose for meat and wool.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'Coffee Quality & Processing for Premium Markets', instructor: 'JARC Research Team', thumbnail: '/stock/cocoa.svg', lessonsCount: 10, category: 'Economics', difficulty: 'Advanced', duration: '3h 30m', completed: false, description: 'Wet and dry processing methods, quality grading, and specialty coffee market access for Ethiopian growers.', videoId: '6S6PJ8W1gbM', progress: 0, completedLessons: [] },
      { id: '2', title: 'Teff Agronomy for Smallholders', instructor: 'EIAR/Ambo Center', thumbnail: '/stock/crop-default.svg', lessonsCount: 6, category: 'Resilience', difficulty: 'Beginner', duration: '1h 30m', completed: false, description: 'Quncho variety management, sowing rates, and nitrogen top-dressing timing. Increasing teff yields on smallholder plots.', videoId: 'h2P5z2Q3yJ0', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Tigist A.', text: 'Coffee flowering is excellent in Sidama this year. If Kiremt rains hold, we should have a great main crop.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Dawit Tadesse', role: 'Coffee Farmer (Jimma)', img: '/stock/user.svg', mutual: 6 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'EthCoffee', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  SN: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Groundnut', variety: '55-437 (ISRA)', plantingDate: '2026-06-15', harvestDate: '2026-10-31', status: 'Healthy', area: 20, imageUrl: '/stock/groundnut.svg', soilHealth: 'Degraded', waterEfficiency: 'Moderate', biodiversityScore: 45 },
      { id: '2', name: 'Millet', variety: 'Souna 3 (ISRA)', plantingDate: '2026-07-01', harvestDate: '2026-11-15', status: 'Healthy', area: 15, imageUrl: '/stock/millet.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 60 },
      { id: '3', name: 'Rice', variety: 'Sahel 108 (AfricaRice)', plantingDate: '2026-07-15', harvestDate: '2026-11-30', status: 'Needs Attention', area: 8, imageUrl: '/stock/rice.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 50 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Peul Cattle Herd', species: 'Cattle', count: 50, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/crop-default.svg', notes: 'Zebu Gobra. Transhumance system — dry season migration south.' },
      { id: '2', name: 'Local Goat Herd', species: 'Goat', count: 35, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/cattle.svg', notes: 'Djallonke goat. Adapted to Sahel conditions.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'Groundnut Aflatoxin Prevention', instructor: 'ISRA/CORAF Team', thumbnail: '/stock/groundnut.svg', lessonsCount: 8, category: 'Resilience', difficulty: 'Intermediate', duration: '2h 00m', completed: false, description: 'Harvest timing, proper drying, and storage techniques to minimize aflatoxin contamination in groundnut.', videoId: '3VfJxKq3wJ0', progress: 0, completedLessons: [] },
      { id: '2', title: 'Sahel Irrigation Techniques', instructor: 'AfricaRice Sahel Station', thumbnail: '/stock/rice.svg', lessonsCount: 10, category: 'Tech', difficulty: 'Intermediate', duration: '3h 00m', completed: false, description: 'Smallholder irrigation options for the Sahel: treadle pumps, California drip systems, and lowland rice management.', videoId: '1s5o7s3y_wY', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Ousmane N.', text: 'Premieres pluies a Kaolack. On peux commencer le semis dacahuete. Attention aux secheresses en juillet selon les previsions.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Dr. Ousmane Diop', role: 'Livestock Vet (Senegal)', img: '/stock/user.svg', mutual: 10 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'ISRA Senegal', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  AU: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Wheat', variety: 'Scepter (AGT)', plantingDate: '2026-05-01', harvestDate: '2026-12-15', status: 'Healthy', area: 500, imageUrl: '/stock/sorghum.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 30 },
      { id: '2', name: 'Barley', variety: 'RGT Planet', plantingDate: '2026-05-15', harvestDate: '2026-12-31', status: 'Healthy', area: 300, imageUrl: '/stock/sorghum.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 35 },
      { id: '3', name: 'Canola', variety: '44Y90 (Corteva)', plantingDate: '2026-04-15', harvestDate: '2026-11-30', status: 'Needs Attention', area: 200, imageUrl: '/stock/crop-default.svg', soilHealth: 'Degraded', waterEfficiency: 'Low', biodiversityScore: 22 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Merino Sheep Flock', species: 'Sheep', count: 3000, status: 'Healthy', grazingType: 'Rotational', imageUrl: '/stock/crop-default.svg', notes: 'Merino wool flock. Rotational grazing on improved pasture with supplementary feeding in dry periods.' },
      { id: '2', name: 'Beef Cattle Herd', species: 'Cattle', count: 80, status: 'Healthy', grazingType: 'Rotational', imageUrl: '/stock/sheep.svg', notes: 'Angus herd. Cell grazing system on native pasture.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'No-Till Farming for Dryland Cropping', instructor: 'GRDC Research Team', thumbnail: '/stock/crop-default.svg', lessonsCount: 8, category: 'Resilience', difficulty: 'Intermediate', duration: '2h 30m', completed: false, description: 'No-till establishment, stubble retention, and controlled traffic farming for Australian dryland systems. Soil health and moisture conservation.', videoId: '3VfJxKq3wJ0', progress: 0, completedLessons: [] },
      { id: '2', title: 'Grazing Management for Rangelands', instructor: 'MLA/DPIRD Team', thumbnail: '/stock/cattle.svg', lessonsCount: 10, category: 'Resilience', difficulty: 'Advanced', duration: '3h 00m', completed: false, description: 'Cell grazing, stocking rate calculations, and drought management for extensive sheep and cattle operations.', videoId: '6S6PJ8W1gbM', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Jenny S.', text: 'Good autumn break in WA. Sowing on track for wheat and barley. Canola going in this week.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Graham Hughes', role: 'Grain Farmer (WA)', img: '/stock/user.svg', mutual: 4 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'GRDC', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  DE: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Winter Wheat', variety: 'Julius (KWS)', plantingDate: '2025-10-10', harvestDate: '2026-08-15', status: 'Healthy', area: 80, imageUrl: '/stock/sorghum.svg', soilHealth: 'Excellent', waterEfficiency: 'High', biodiversityScore: 52 },
      { id: '2', name: 'Winter Barley', variety: 'SY Planet', plantingDate: '2025-09-20', harvestDate: '2026-07-31', status: 'Harvest Ready', area: 50, imageUrl: '/stock/sorghum.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 48 },
      { id: '3', name: 'Sugar Beet', variety: 'KWS Safari', plantingDate: '2026-03-20', harvestDate: '2026-10-31', status: 'Healthy', area: 30, imageUrl: '/stock/crop-default.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 40 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Holstein Dairy Herd', species: 'Cattle', count: 120, status: 'Lactating', grazingType: 'Free Range', imageUrl: '/stock/crop-default.svg', notes: 'Holstein Friesian dairy. Pasture-based with TMR supplementation. Average 9,500 L/cow/year.' },
      { id: '2', name: 'Schwäbisch-Häll Pigs', species: 'Pig', count: 80, status: 'Healthy', grazingType: 'Feedlot', imageUrl: '/stock/cattle.svg', notes: 'Swabian-Hall breed, premium pork program. Free-range finishing on straw bedding.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'CAP 2026 Compliance & Eco-Schemes', instructor: 'Bundesinformation Landwirtschaft', thumbnail: '/stock/crop-default.svg', lessonsCount: 8, category: 'Economics', difficulty: 'Intermediate', duration: '2h 30m', completed: false, description: 'Updated CAP eco-scheme requirements, EFA compliance, and green payment eligibility for 2026.', videoId: 'p4mEjL6y6Vk', progress: 0, completedLessons: [] },
      { id: '2', title: 'Precision Dairy Management', instructor: 'DLG Expert Panel', thumbnail: '/stock/cattle.svg', lessonsCount: 10, category: 'Tech', difficulty: 'Advanced', duration: '3h 00m', completed: false, description: 'Automated milking, health monitoring collars, and feed optimization for European dairy operations.', videoId: 'G9K7z9JcQj8', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Petra K.', text: 'Wheat looking excellent in Bayern. Stripe rust pressure low so far — hope it stays that way. Fungicide T1 applied.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Hans Müller', role: 'Arable Farmer (Bayern)', img: '/stock/user.svg', mutual: 3 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'DLG Frankfurt', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  TH: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Rice (Jasmine)', variety: 'KDML 105 (Khao Dawk Mali)', plantingDate: '2026-06-01', harvestDate: '2026-11-30', status: 'Healthy', area: 30, imageUrl: '/stock/rice.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 60 },
      { id: '2', name: 'Rubber', variety: 'RRIM 600', plantingDate: '2020-05-01', harvestDate: '2026-12-31', status: 'Healthy', area: 20, imageUrl: '/stock/crop-default.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 45 },
      { id: '3', name: 'Cassava', variety: 'Rayong 9 (RD 9)', plantingDate: '2026-05-15', harvestDate: '2027-05-15', status: 'Needs Attention', area: 15, imageUrl: '/stock/cassava.svg', soilHealth: 'Degraded', waterEfficiency: 'Low', biodiversityScore: 28 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Buffalo Draft Herd', species: 'Cattle', count: 8, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/crop-default.svg', notes: 'Swamp buffalo. Traditional paddy draft animals — being replaced by tractors on larger farms.' },
      { id: '2', name: 'Broiler Contract Flock', species: 'Chicken', count: 8000, status: 'Healthy', grazingType: 'Feedlot', imageUrl: '/stock/cattle.svg', notes: 'CP Group contract broilers. 38-day cycle. Full biosecurity.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'SRI Rice for Water Conservation', instructor: 'Rice Department Thailand', thumbnail: '/stock/rice.svg', lessonsCount: 8, category: 'Resilience', difficulty: 'Intermediate', duration: '2h 00m', completed: false, description: 'System of Rice Intensification for Thai jasmine rice. Reducing water use 40% while maintaining quality grade.', videoId: '1s5o7s3y_wY', progress: 0, completedLessons: [] },
      { id: '2', title: 'Rubber Latex Quality & Tapping Efficiency', instructor: 'RRIT Research Division', thumbnail: '/stock/crop-default.svg', lessonsCount: 10, category: 'Economics', difficulty: 'Advanced', duration: '3h 00m', completed: false, description: 'Optimizing tapping panels, rain guarding, and latex preservation for THB/kg margin improvement.', videoId: 'p4mEjL6y6Vk', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Niran K.', text: 'Monsoon is progressing normally in Isan. Good rainfall this week. Start rice nursery preparation now.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Somchai Phan', role: 'Rice Farmer (Surin)', img: '/stock/user.svg', mutual: 7 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'RiceDeptTH', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
  ...
  MX: {
    ...
    areaUnit: 'ha',
    defaultCrops: [
      { id: '1', name: 'Maize', variety: 'H-520 (INIFAP)', plantingDate: '2026-05-01', harvestDate: '2026-11-30', status: 'Healthy', area: 30, imageUrl: '/stock/maize.svg', soilHealth: 'Good', waterEfficiency: 'Moderate', biodiversityScore: 40 },
      { id: '2', name: 'Avocado', variety: 'Hass', plantingDate: '2021-06-01', harvestDate: '2026-12-31', status: 'Healthy', area: 15, imageUrl: '/stock/fruit-tree.svg', soilHealth: 'Good', waterEfficiency: 'High', biodiversityScore: 62 },
      { id: '3', name: 'Coffee (Arabica)', variety: 'Typica (Oro Azteca)', plantingDate: '2022-05-01', harvestDate: '2026-12-31', status: 'Needs Attention', area: 8, imageUrl: '/stock/cocoa.svg', soilHealth: 'Degraded', waterEfficiency: 'Moderate', biodiversityScore: 55 },
    ],
    defaultLivestock: [
      { id: '1', name: 'Brahman Beef Herd', species: 'Cattle', count: 60, status: 'Healthy', grazingType: 'Rotational', imageUrl: '/stock/crop-default.svg', notes: 'Brahman-cross beef cattle. Rotational grazing on buffelgrass pasture in Veracruz.' },
      { id: '2', name: 'Creole Goat Herd', species: 'Goat', count: 80, status: 'Healthy', grazingType: 'Free Range', imageUrl: '/stock/cattle.svg', notes: 'Creole goats for meat. Rangeland grazing in semi-arid regions.' },
    ],
    marketPrices: [
    ...
    learningModules: [
      { id: '1', title: 'Avocado Export Quality & Phytosanitary', instructor: 'INIFAP/CESAVEG Team', thumbnail: '/stock/fruit-tree.svg', lessonsCount: 10, category: 'Economics', difficulty: 'Advanced', duration: '3h 00m', completed: false, description: 'Post-harvest handling, packing standards, and phytosanitary certification for avocado export to US and Asian markets.', videoId: 'p4mEjL6y6Vk', progress: 0, completedLessons: [] },
      { id: '2', title: 'Coffee Leaf Rust Management', instructor: 'INIFAP Coffee Program', thumbnail: '/stock/cocoa.svg', lessonsCount: 8, category: 'Resilience', difficulty: 'Intermediate', duration: '2h 30m', completed: false, description: 'Identifying CLR symptoms, fungicide timing, and transitioning to resistant Lempira and Oro Azteca varieties.', videoId: '6S6PJ8W1gbM', progress: 0, completedLessons: [] },
    ],
    tasks: [
    ...
    chatMessages: [
      { id: '1', channelId: 'general', author: 'Miguel H.', text: 'Lluvias regulares en Veracruz. Buen inicio de temporada para maiz y aguacate. Cuidado con la canicula en julio.', timestamp: new Date(Date.now() - 3600000).toISOString(), avatar: '/stock/user.svg', isMe: false },
    ],
    trends: [
    ...
    suggestedUsers: [
      { id: 'sf1', name: 'Rosa Lopez', role: 'Avocado Grower (Michoacan)', img: '/stock/user.svg', mutual: 9 },
    ],
    stories: [
      { id: 'create', name: 'Add Story', img: '/stock/user.svg', isUser: true },
      { id: '1', name: 'AvoMex', img: '/stock/crop-default.svg', hasUpdate: true },
    ],
